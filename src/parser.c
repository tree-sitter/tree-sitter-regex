...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [111] = {.count = 1, .reusable = false}, REDUCE(sym_class_range, 1, .alias_sequence_id = 1),
  [113] = {.count = 1, .reusable = false}, SHIFT(51),
  [115] = {.count = 1, .reusable = true}, REDUCE(sym_class_range, 1, .alias_sequence_id = 1),
  [117] = {.count = 1, .reusable = false}, REDUCE(sym_class_range, 1, .alias_sequence_id = 2),
  [119] = {.count = 1, .reusable = false}, SHIFT(52),
  [121] = {.count = 1, .reusable = true}, REDUCE(sym_class_range, 1, .alias_sequence_id = 2),
